...
namespace Lesson7_8
{
    class Program
    {
        ...
        static void BubleSorting() 
        {
            ...
            BubbleSorter<int> bubS = new BubbleSorter<int>(intArray);
        ...
        static void InsertionSorting()
        {
            ...
            InsertionSorter<int> insS = new InsertionSorter<int>(intArray);
            for (int i = 0; i < arrayLenght; i++)
            {
                Console.Write(" " + intArray[i]);
            }
        ...
        static void StackBuffering() 
        {
            ...
            MyStack<int> stack = new MyStack<int>(stackArray);
            Console.WriteLine("");
            Console.WriteLine("--------------------------------------------------");
        ...
        static void QueueBuffering() 
        {
            ...
            MyQueue<int> queue = new MyQueue<int>(stackArray);
            Console.WriteLine("");
            Console.WriteLine("--------------------------------------------------");
